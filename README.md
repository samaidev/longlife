...
> 从整个知识库寻找"永生药突破口"：定义 → 候选 → 机制 → 路线图 四层递进。不贩卖永生幻想，把"永生"拆解为可评估的科学问题。

- [01-永生的科学定义与可行性框架](09-immortality/01-immortality-framework.md)
- [02-永生药候选突破口：六大路径横向对比](09-immortality/02-breakthrough-candidates.md)
- [03-死亡机制与寿命极限](09-immortality/03-death-mechanism.md)
- [04-永生药研发路线图](09-immortality/04-roadmap.md)

### 10 · 分子结构深潜 Molecular Structures
> 从"通路级"升级到"结构级"：以 PDB 晶体结构/冷冻电镜为锚点，解剖核心靶点的三维结构、活性位点原子细节、结合口袋与构象变化。

- [01-一氧化氮合酶（NOS）家族三维结构](10-structures/01-nos-structures.md)
- [02-sGC 与 H-NOX 血红素传感器](10-structures/02-sgc-heme.md)
- [03-AMPK 异源三聚体](10-structures/03-ampk-structure.md)
- [04-mTORC1 深埋活性位点](10-structures/04-mtor-structure.md)
- [05-TET 双加氧酶与 DNA 去甲基化](10-structures/05-tet-dna.md)
- [06-SIRT1 结构与 NAD⁺ 依赖催化](10-structures/06-sirt1-structure.md)
- [07-DNMT1 与 DNA 甲基化写入](10-structures/07-dnmt1-structure.md)
- [08-CD38 与 NAD⁺ 消耗](10-structures/08-cd38-structure.md)
- [09-PARP1 与 DNA 损伤修复](10-structures/09-parp1-structure.md)
- [10-NAMPT 与 NAD⁺ 再生](10-structures/10-nampt-structure.md)
- [11-端粒酶与端粒延长](10-structures/11-telomerase-structure.md)
...
- [16-FOXO3 与长寿基因](10-structures/16-foxo3-structure.md)
- [17-GLP-1R 与代谢抗衰](10-structures/17-glp1r-structure.md)
...
- [22-核糖体与蛋白质合成](10-structures/22-ribosome.md)
- [23-Hsp70 与折叠救援队](10-structures/23-hsp70.md)
- [24-PINK1/Parkin 与线粒体质检](10-structures/24-pink1-parkin.md)
- [25-HSF1 与应激总指挥](10-structures/25-hsf1.md)
...
- [33-SIRT6 与基因组卫士](10-structures/33-sirt6-structure.md)
...
- [38-ATP合酶 与旋转马达](10-structures/38-atp-synthase.md)
- [39-GPX4 与铁死亡闸门](10-structures/39-gpx4.md)
- [40-脂氧合酶与脂质点火](10-structures/40-lox.md)
- [41-xCT 与铁死亡供料站](10-structures/41-xct.md)
- [42-COX-2 与炎症衰老点火器](10-structures/42-cox2.md)
- [43-cPLA2α 与 AA 经济总阀](10-structures/43-cpla2.md)
- [44-sEH 与 EET 保护闸门](10-structures/44-seh.md)
- [45-HMGCR 与胆固醇限速阀](10-structures/45-hmgcr.md)
- [46-PCSK9 与降脂新武器](10-structures/46-pcsk9.md)
- [47-NPC1L1 与胆固醇吸收闸门](10-structures/47-npc1l1.md)
- [48-CETP 与胆固醇转运通道](10-structures/48-cetp.md)
- [49-ApoA1 与胆固醇逆转运载体](10-structures/49-apoa1.md)
- [50-LDLR 与胆固醇清除执行器](10-structures/50-ldlr.md)
...
全部 **65 篇**研究文档已深化至 **纯汉字 5000+**（按纯汉字严格标准 100% 达标，总纯汉字 38 万+），每篇包含：
- 核心概念 + 分子机制全链条（含通路图/表格）
- 证据分级表（实锤/强关联/动物支持/机制推测）
- 临床与实验证据细节（剂量/效应量/样本量）
- 与 NO / NAD+ / SIRT1 长寿网络联系
- 干预方向与开放问题
- 真实参考文献（10-40 条/篇）

**2026-09-21 里程碑二：新增 10-structures 分子结构深潜专题（50 篇）**
...
- AMPK：γ 亚基 4 CBS 位点、AMP 结合→AID 脱开、ADaM/C2 变构位点
- mTORC1：深埋活性位点、FRB"门卫"、FKBP12-雷帕霉素"堵门"（变构 vs 正构）
- TET2：Fe(II)-His-His-Asp + 2OG 活性中心、5mC 碱基翻转、三步氧化、TDG/BER 完成去甲基化
- 每篇含"原子级中文解读"（氧气活化四步、配体选择性化学、构象多米诺、双钥匙逻辑、分子规模感）与结构-功能"五问"总结

**2026-09-21 里程碑一：全部 60 篇纯汉字 5000+ 达标**
- 新增 09-immortality 永生药专题（4 篇）：表观重编程（ER-100 人体 I 期）居首，Senolytics/mTOR 次之
- 第 13–31 波深化：将 18 篇"总字符达标但纯汉字不足"的历史篇目全部补至 5000+

主线贯穿：NO 通路 · NAD+/SIRT1 网络 · 12 大衰老标志 · 中药益气活血与 NO 交叉 · 前沿抗衰（重编程/Senolytics/mTOR/AI 药物）· 永生药路线 · 分子结构底座
